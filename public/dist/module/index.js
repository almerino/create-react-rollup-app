...
function Qa(a){if(a&&a.dispatchConfig.phasedRegistrationNames){for(var b=a._targetInst,c=[];b;)c.push(b),b=Oa(b);for(b=c.length;0<b--;)Pa(c[b],"captured",a);for(b=0;b<c.length;b++)Pa(c[b],"bubbled",a);}}function Ra(a,b,c){a&&c&&c.dispatchConfig.registrationName&&(b=Fa(a,c.dispatchConfig.registrationName))&&(c._dispatchListeners=ya(c._dispatchListeners,b),c._dispatchInstances=ya(c._dispatchInstances,a));}function Ua(a){za(a,Qa);}var Va=!("undefined"===typeof window||!window.document||!window.document.createElement);function Wa(a,b){var c={};c[a.toLowerCase()]=b.toLowerCase();c["Webkit"+a]="webkit"+b;c["Moz"+a]="moz"+b;return c}var Ya={animationend:Wa("Animation","AnimationEnd"),animationiteration:Wa("Animation","AnimationIteration"),animationstart:Wa("Animation","AnimationStart"),transitionend:Wa("Transition","TransitionEnd")},Za={},$a={};
...
a){!Lg&&0!==O$1&&b<O$1&&Pg();Ze(a,b);if(!Lg||Og||Mg!==a){b=a;a=a.expirationTime;if(null===b.nextScheduledRoot)b.expirationTime=a,null===T$1?(U$1=T$1=b,b.nextScheduledRoot=b):(T$1=T$1.nextScheduledRoot=b,T$1.nextScheduledRoot=U$1);else if(c=b.expirationTime,0===c||a<c)b.expirationTime=a;V$1||(W$1?Wg&&(Y$1=b,Z$1=1,Xg(b,1,!0)):1===a?Yg(1,null):Zg(b,a));}$g>ah&&($g=0,t$1("185"));}}var U$1=null,T$1=null,ch=0,dh=void 0,V$1=!1,Y$1=null,Z$1=0,Vg=0,eh=!1,fh=!1,gh=null,hh=null,W$1=!1,Wg=!1,Ug=!1,ih=null,jh=schedule.unstable_now(),kh=(jh/10|0)+2,lh=kh,ah=50,$g=0,mh=null,nh=1;function oh(){kh=((schedule.unstable_now()-jh)/10|0)+2;}function Zg(a,b){if(0!==ch){if(b>ch)return;null!==dh&&schedule.unstable_cancelScheduledWork(dh);}ch=b;a=schedule.unstable_now()-jh;dh=schedule.unstable_scheduleWork(ph,{timeout:10*(b-2)-a});}function Gf(){if(V$1)return lh;qh();if(0===Z$1||1073741823===Z$1)oh(),lh=kh;return lh}
...
q.nodeType&&y.push({element:q,left:q.scrollLeft,top:q.scrollTop});"function"===typeof w.focus&&w.focus();for(w=0;w<y.length;w++)q=y[w],q.element.scrollLeft=q.left,q.element.scrollTop=q.top;}ye=null;Gd=!!xe;xe=null;a.current=b;for(Q$1=d;null!==Q$1;){d=!1;w=void 0;try{for(y=c;null!==Q$1;){var Sa=Q$1.effectTag;if(Sa&36){var oc=Q$1.alternate;q=Q$1;p=y;switch(q.tag){case 2:case 3:var X=q.stateNode;if(q.effectTag&4)if(null===oc)X.props=q.memoizedProps,X.state=q.memoizedState,X.componentDidMount();else{var Ih=oc.memoizedProps,
...
case 8:break;case 6:break;case 15:break;case 16:break;default:t$1("163");}}if(Sa&128){var Ac=Q$1.ref;if(null!==Ac){var mg=Q$1.stateNode;switch(Q$1.tag){case 7:var Pd=mg;break;default:Pd=mg;}"function"===typeof Ac?Ac(Pd):Ac.current=Pd;}}var Lh=Q$1.nextEffect;Q$1.nextEffect=null;Q$1=Lh;}}catch(Xa){d=!0,w=Xa;}d&&(null===Q$1?t$1("178"):void 0,wg(Q$1,w),null!==Q$1&&(Q$1=Q$1.nextEffect));}Lg=Og=!1;"function"===typeof Oe&&Oe(b.stateNode);Sa=b.expirationTime;b=b.childExpirationTime;b=0===Sa||0!==b&&b<Sa?b:Sa;0===b&&(Fg=null);a.expirationTime=
b;a.finishedWork=null;}function Tg(){return eh?!0:null===hh||hh.timeRemaining()>nh?!1:eh=!0}function Dg(a){null===Y$1?t$1("246"):void 0;Y$1.expirationTime=0;fh||(fh=!0,gh=a);}function sh(a,b){var c=W$1;W$1=!0;try{return a(b)}finally{(W$1=c)||V$1||Yg(1,null);}}function uh(a,b,c){if(Ug)return a(b,c);W$1||V$1||0===Vg||(Yg(Vg,null),Vg=0);var d=Ug,e=W$1;W$1=Ug=!0;try{return a(b,c)}finally{Ug=d,(W$1=e)||V$1||Yg(1,null);}}
...
Lb=sh;Mb=uh;Nb=function(){V$1||0===Vg||(Yg(Vg,null),Vg=0);};
(function(a){var b=a.findFiberByHostInstance;return Re(objectAssign({},a,{findHostInstanceByFiber:function(a){a=md(a);return null===a?null:a.stateNode},findFiberByHostInstance:function(a){return b?b(a):null}}))})({findFiberByHostInstance:Ka,bundleType:0,version:"16.5.1",rendererPackageName:"react-dom"});
...
var css = ".App_app__NghkZ {\n  height: 100vh;\n  background: linear-gradient(to right, #f2709c, #ff9472);\n  text-align: center\n}\n.App_app__NghkZ code {\n    color: #750313;\n  }\n.App_app__NghkZ .App_appHeader__1M4JE {\n    color: white;\n    padding: 100px;\n  }\n.App_app__NghkZ .App_reactSvg__uCszG {\n    margin: 0 auto\n  }\n.App_app__NghkZ .App_reactSvg__uCszG path {\n      fill: transparent;\n    }\n.App_app__NghkZ .App_link__3U4Ny {\n    color: #00d8ff;\n    padding: 20px;\n  }\n";
var styles = {"app":"App_app__NghkZ","appHeader":"App_appHeader__1M4JE","reactSvg":"App_reactSvg__uCszG","link":"App_link__3U4Ny"};
styleInject(css);
